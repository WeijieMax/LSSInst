...
work_dir = None
load_from = "https://github.com/Divadi/SOLOFusion/releases/download/v0.1.0/r50-fp16_phase2_ema.pth"
freeze_bev = False
...
model = dict(
    ...
    img_backbone=dict(
        pretrained='/ceph-jd/pub/jupyter/chencong/notebooks/resnet50-0676ba61.pth',
        type='ResNet',
        depth=50,
        num_stages=4,
        out_indices=(0, 1, 2, 3),
