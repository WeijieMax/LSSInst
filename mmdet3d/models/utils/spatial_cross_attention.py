...
class SpatialCrossAttention(BaseModule):
    ...
    def feature_sampling_4d(self, mlvl_feats, reference_points, velocity, pc_range, img_metas, use_vel=True):
    ...
    def forward(self,
        ...
        reference_points_cam, bev_mask = self.feature_sampling_4d(
            bev_feats[0], reference_points, velocity, self.pc_range, kwargs['img_metas'])
